...
/***/ function(module, exports, __webpack_require__) {
	...
	var _feedtable = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	//LootTable
	//Track & Update Loot
	var LootTable = _react2.default.createClass({
	   displayName: 'LootTable',

	   loadLootFromServer: function loadLootFromServer() {
	      $.ajax({
	         url: this.props.url,
	         dataType: 'json',
	         cache: false,
	   ...
	   render: function render() {
	      return _react2.default.createElement(Loot, { data: this.state.data });
	   }
	});
	...
	//Loot
	//Build Loot Table
	var LootRow = _react2.default.createClass({
	   displayName: 'LootRow',
	   ...
	   render: function render() {
	      ...
	      return _react2.default.createElement(
	         'tr',
	         { className: "lootrow" + (this.props.loot.ID % 2 ? "a" : "b") },
	         '>',
	         _react2.default.createElement(
	            'td',
	            null,
	         ...
	         _react2.default.createElement(
	            'td',
	            null,
	            this.props.loot.Datetime
	         )
	      );
	   }
	});

	var Loot = _react2.default.createClass({
	   displayName: 'Loot',
	   ...
	   render: function render() {
	      ...
	      var lootNodes = this.props.data.forEach(function (loot) {
	         ...
	         rows.push(_react2.default.createElement(LootRow, { loot: loot, key: loot.ID }));
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VectorTable = _react2.default.createClass({
	  displayName: 'VectorTable',
	  ...
	  render: function render() {
	    return _react2.default.createElement(AvailableVectors, { data: this.state.data });
	  }
	});
	var handleClick = function handleClick(vector) {
	  console.log(vector);
	};
	var AvailableVectors = _react2.default.createClass({
	  displayName: 'AvailableVectors',
	    ...
	    return _react2.default.createElement(
	      ...
	      this.props.data.map(function (vector) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { id: 'job_cancel_icon', style: { float: 'left' }, onClick: handleClick.bind(this, vector), value: 'tmp' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var JobTable = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(Job, { data: this.state.data });
	  }
	});
	...
	var Job = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var jobNodes = this.props.data.map(function (job, blah) {
	      ...
	      if (job.Enabled == 1) {
	        var runningJob = 'gui/images/loader.gif';
	      } else {
	        var runningJob = '';
	      }
	      ...
	      if (job.Active == "1") {
	        ...
	        return _react2.default.createElement(
	          'span',
	          null,
	          _react2.default.createElement('img', { style: { float: 'right' }, src: runningJob }),
	          _react2.default.createElement(
	            'span',
	            { style: { float: 'left' } },
	            job.Name
	          ...
	          _react2.default.createElement(
	            'div',
	            { id: 'job_cancel_icon', onClick: killJob.bind(this, job), name: job.ID, style: { float: 'right' } },
	            _react2.default.createElement('span', { className: 'icon-cancel-circle' })
	          ),
	          _react2.default.createElement('br', null),
	          _react2.default.createElement('br', null)
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LootNotification = _react2.default.createClass({
	  displayName: 'LootNotification',
...
/***/ function(module, exports, __webpack_require__) {
	...
	//HostList
	//Track & Update Hosts
	var HostList = _react2.default.createClass({
	  displayName: 'HostList',

	  loadHostsFromServer: function loadHostsFromServer() {
	    $.ajax({
	      url: this.props.url,
	      dataType: 'json',
	      cache: false,
	  ...
	  render: function render() {
	    return _react2.default.createElement(Host, { data: this.state.data });
	  }
	});

	//Host
	//Build Host Columns
	var Host = _react2.default.createClass({
	  displayName: 'Host',
	...
	_reactDom2.default.render(_react2.default.createElement(HostList, { url: '/dbquery?qstring=' + btoa(qstring), pollInterval: 2000 }), document.getElementById('hostsfeed'));
